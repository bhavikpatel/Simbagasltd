...
public class EditRODetailListAdapter extends RecyclerView.Adapter<EditRODetailListAdapter.ViewHolder>{

    ArrayList<HashMap<String, String>> podetailList;
    EditReturnOrderActivity context;
    public EditRODetailListAdapter(ArrayList<HashMap<String, String>> dataList, EditReturnOrderActivity activity) {
           ...
           /* rv_row.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    *//*Intent intent=new Intent(context, CylinderDetailActivity.class);
                    ...
                    adb.setTitle("You are sure won't be Delete this RO Order Detail!");
    ...
    @NonNull
    @Override
    public EditRODetailListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull EditRODetailListAdapter.ViewHolder holder, int position) {
