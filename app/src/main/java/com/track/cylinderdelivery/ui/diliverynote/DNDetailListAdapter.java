...
public class DNDetailListAdapter extends RecyclerView.Adapter<DNDetailListAdapter.ViewHolder>{

    ArrayList<HashMap<String, String>> DNdetailList;
    AddDeliveryNoteActivity context;
    public DNDetailListAdapter(ArrayList<HashMap<String, String>> dataList, AddDeliveryNoteActivity activity) {
    ...
    @Override
    public void onBindViewHolder(@NonNull DNDetailListAdapter.ViewHolder holder, int position) {
