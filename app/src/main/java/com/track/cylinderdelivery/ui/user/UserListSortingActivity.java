...
public class UserListSortingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spSorting=context.getSharedPreferences("userFilter",MODE_PRIVATE);

        sortbyName=new ArrayList<>();
        sortbyName.add("Full Name");
        sortbyName.add("Address1");
       // sortbyName.add("None");
