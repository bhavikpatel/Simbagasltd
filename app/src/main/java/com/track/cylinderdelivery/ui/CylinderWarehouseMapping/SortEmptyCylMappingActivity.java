...
public class SortEmptyCylMappingActivity extends AppCompatActivity {
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sort_empty_cyl_mapping);
        context=this;
        ...
        spSorting=context.getSharedPreferences("emptyCylFilter",MODE_PRIVATE);
