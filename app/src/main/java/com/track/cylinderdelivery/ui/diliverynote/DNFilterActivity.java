...
public class DNFilterActivity extends AppCompatActivity {
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dnfilter);
        context=this;
        selectedtext=getIntent().getStringExtra("selectedtext");
        rvBlank=findViewById(R.id.rvBlank);
        btnCancel=findViewById(R.id.btnCancel);
        btnApply=findViewById(R.id.btnApply);
        spPurchaseOrderFilter=context.getSharedPreferences("DNFilter",MODE_PRIVATE);
