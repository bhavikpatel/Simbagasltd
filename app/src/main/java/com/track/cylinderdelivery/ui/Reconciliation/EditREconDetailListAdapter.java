...
public class EditREconDetailListAdapter extends RecyclerView.Adapter<EditREconDetailListAdapter.ViewHolder>{

    ArrayList<HashMap<String, String>> podetailList;
    EditReconciliationActivity context;
    public EditREconDetailListAdapter(ArrayList<HashMap<String, String>> dataList, EditReconciliationActivity activity) {
    ...
    @NonNull
    @Override
    public EditREconDetailListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull EditREconDetailListAdapter.ViewHolder holder, int position) {
