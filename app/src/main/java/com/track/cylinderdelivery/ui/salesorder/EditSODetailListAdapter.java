...
public class EditSODetailListAdapter extends RecyclerView.Adapter<EditSODetailListAdapter.ViewHolder>{

    ArrayList<HashMap<String, String>> podetailList;
    EditSalesOrderActivity context;
    public EditSODetailListAdapter(ArrayList<HashMap<String, String>> dataList, EditSalesOrderActivity activity) {
    ...
    @NonNull
    @Override
    public EditSODetailListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull EditSODetailListAdapter.ViewHolder holder, int position) {
