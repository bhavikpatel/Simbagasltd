...
public class EditDNDetailListAdapter extends RecyclerView.Adapter<EditDNDetailListAdapter.ViewHolder>{

    ArrayList<HashMap<String, String>> DNdetailList;
    EditDeliveryNoteActivity context;
    public EditDNDetailListAdapter(ArrayList<HashMap<String, String>> dataList, EditDeliveryNoteActivity activity) {
    ...
    @NonNull
    @Override
    public EditDNDetailListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull EditDNDetailListAdapter.ViewHolder holder, int position) {

        // Get element from your dataset at this position and replace the
        // contents of the view with that element
        holder.imgArrow.setTag(position);
        holder.rv_row.setTag(position);
        holder.txtProductName.setText(DNdetailList.get(position).get("cylinderList"));
