...
public class DeliveryNoteSortingActivity extends AppCompatActivity {
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delivery_note_sorting);
        context=this;
        ...
        sortbyName.add("DN Number");
        sortbyName.add("Generated By");
        // sortbyName.add("None");
