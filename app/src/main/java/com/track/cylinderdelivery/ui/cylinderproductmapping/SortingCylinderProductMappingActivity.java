...
public class SortingCylinderProductMappingActivity extends AppCompatActivity {
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sorting_cylinder_product_mapping);
        context=this;
        ...
        spSorting=context.getSharedPreferences("CPMSoring",MODE_PRIVATE);
