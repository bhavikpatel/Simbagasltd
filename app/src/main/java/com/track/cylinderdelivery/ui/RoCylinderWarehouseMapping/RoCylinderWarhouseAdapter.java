...
public class RoCylinderWarhouseAdapter extends RecyclerView.Adapter<RoCylinderWarhouseAdapter.ViewHolder>{

    ArrayList<HashMap<String, String>> podetailList;
    Activity context;
    public RoCylinderWarhouseAdapter(ArrayList<HashMap<String, String>> dataList, Activity activity) {
...
/*            imgArrow.setOnClickListener(new View.OnClickListener() {
    ...
    @NonNull
    @Override
    public RoCylinderWarhouseAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RoCylinderWarhouseAdapter.ViewHolder holder, int position) {

        // Get element from your dataset at this position and replace the
        // contents of the view with that element
        holder.imgArrow.setTag(position);
        holder.txtProductName.setText(podetailList.get(position).get("cylinderNo"));
        holder.txtQuantity.setText("User Name: "+podetailList.get(position).get("userName")+"\n"+
