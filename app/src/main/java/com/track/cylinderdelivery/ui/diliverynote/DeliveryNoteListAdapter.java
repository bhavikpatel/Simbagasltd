...
public class DeliveryNoteListAdapter extends RecyclerView.Adapter<DeliveryNoteListAdapter.ViewHolder>{
    ...
    Activity context;
    public DeliveryNoteListAdapter(ArrayList<HashMap<String, String>> dataList, Activity activity) {
        ...
        public ViewHolder(View view) {
            ...
            rvBackground.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent=new Intent(context, DeliveryNoteDetailActivity.class);
                    intent.putExtra("editData",podetailList.get(pos));
                    context.startActivity(intent);
                    context.overridePendingTransition(R.anim.enter_from_bottom, R.anim.hold_top);
                }
    ...
    @NonNull
    @Override
    public DeliveryNoteListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull DeliveryNoteListAdapter.ViewHolder holder, int position) {

        // Get element from your dataset at this position and replace the
        // contents of the view with that element
        holder.imgArrow.setTag(position);
        holder.rvBackground.setTag(position);
        holder.txtPonumber.setText(MySingalton.convertString(podetailList.get(position).get("dnNumber")));
        holder.txtUserName.setText(MySingalton.convertString(podetailList.get(position).get("username"))+
                "\nQuantity: "+MySingalton.convertString(podetailList.get(position).get("quantity"))+
                "\nCreated by: "+MySingalton.convertString(podetailList.get(position).get("dnGeneratedBy"))+
                "\nCreated Date: "+MySingalton.convertString(podetailList.get(position).get("strDNDate")));
        holder.txtStatus.setText(MySingalton.convertString(podetailList.get(position).get("status")));
