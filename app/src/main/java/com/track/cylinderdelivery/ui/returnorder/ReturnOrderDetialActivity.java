...
public class ReturnOrderDetialActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_return_order_detial);
        ...
        txtPoNumber.setText(mapdata.get("roNumber"));
        txtUserName.setText(mapdata.get("username"));
        txtStatus.setText(mapdata.get("status"));
        txtCreatedBy.setText(mapdata.get("roGeneratedBy"));
        txtCreatedDate.setText(mapdata.get("strRODate"));
        ...
        btnReport.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Uri url=Uri.parse(MySingalton.getInstance().URL+"/Api/MobReturnOrder/PrintRO?Id="+
                        mapdata.get("roId"));
                Log.d("user==>",url+"");
                Intent browserIntent = new Intent(Intent.ACTION_VIEW,
                        Uri.parse(MySingalton.getInstance().URL+"/Api/MobReturnOrder/PrintRO?Id="+
                                mapdata.get("roId")));
