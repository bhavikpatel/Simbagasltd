...
public class ProductEditListAdapter extends RecyclerView.Adapter<ProductEditListAdapter.ViewHolder>{

    ArrayList<HashMap<String, String>> podetailList;
    EditPurchaseOrderActivity context;
    public ProductEditListAdapter(ArrayList<HashMap<String, String>> dataList, EditPurchaseOrderActivity activity) {
    ...
    @NonNull
    @Override
    public ProductEditListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ProductEditListAdapter.ViewHolder holder, int position) {
