...
public class SortCylinderMappingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sort_cylinder_mapping);
        context=this;
        ...
        spSorting=context.getSharedPreferences("filledCylFilter",MODE_PRIVATE);

        sortbyName=new ArrayList<>();
        sortbyName.add("Warehouse Name");
        sortbyName.add("User Name");
        sortbyName.add("CylinderNo");
