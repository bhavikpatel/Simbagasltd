...
public class CompanyListSortingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_list_sorting);
        context=this;
        ...
        spSorting=context.getSharedPreferences("CompanySortign",MODE_PRIVATE);

        sortbyName=new ArrayList<>();
        sortbyName.add("Company Name");
        sortbyName.add("Admin Name");
         sortbyName.add("Status");
